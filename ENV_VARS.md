...
- **Security / Clockify:** `CLOCKIFY_JWKS_URL`, `CLOCKIFY_JWKS_PROD_URL`, `CLOCKIFY_JWKS_DEV_URL`, `CLOCKIFY_ENVIRONMENT`, `REQUIRE_SIGNATURE_VERIFICATION`, `WEBHOOK_HMAC_SECRET`, `CLOCKIFY_ALLOWED_API_DOMAINS`
